 ...
 */
    ...
    public function getToutLesMois(){
    ...
    public function getFraisparPoste($mois){
        
        $req = "SELECT  idFraisForfait, sum(quantite*montant) as total FROM lignefraisforfait INNER JOIN fraisforfait ON IdFraisForfait = id 
    ...
    public function getNbLigne($idVisiteur ,$mois){
        
        $req = "select count(idFraisForfait) as nbLigne from lignefraisforfait 
